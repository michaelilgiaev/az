...
| Edition: Azzio Component / Stock Arch | 599 / 522 |
...
This document does not list packages. The complete component enumeration -- every package, its version, and the dependency edges between them -- lives in two companion artifacts, all in `documentations/`:
