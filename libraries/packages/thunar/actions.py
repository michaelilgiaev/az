...
gedit" (no quotes): the gettext .mo override (packages/thunar/locale) relabels the
...
def link_script() -> str:
    ...
    return """\
#!/usr/bin/env bash
# Azzio `link` helper. Generated by packages/thunar (edit the Python, not this file).
...
<!-- Azzio Thunar custom actions. Generated by packages/thunar (edit the Python, not
