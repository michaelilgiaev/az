...
def thunarrc() -> str:
    ...
    lines = [
        "# Azzio Thunar settings. Generated by packages/thunar (edit the Python, not this",
...
def xfconf_channel_xml() -> str:
    ...
    lines = [
        ...
        "",
        "<!-- Azzio Thunar settings (Xfconf channel). Generated by packages/thunar",
...
def gtk_css() -> str:
    ...
    return f"""\
/* Azzio Thunar font bump (~20 percent). Generated by packages/thunar (edit the Python, not
