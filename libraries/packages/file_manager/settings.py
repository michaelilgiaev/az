...
def thunarrc() -> str:
    ...
    lines = [
        "# Azzio Thunar settings. Generated by packages/file_manager (edit the Python, not this",
...
def xfconf_channel_xml() -> str:
    ...
    lines = [
        ...
        "",
        "<!-- Azzio Thunar settings (Xfconf channel). Generated by packages/file_manager",
